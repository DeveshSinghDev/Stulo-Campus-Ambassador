function Say() {
  ...
  return (
    <div className="bg-[#f8f1d8] py-10 md:py-20 overflow-hidden">

      {/* Heading */}
      <div className="text-center px-4">
        <h1 className="text-3xl md:text-5xl font-sans text-gray-800">
          What ambassadors have to say
        </h1>

        <p className="mt-3 text-sm md:text-base text-gray-500">
          A word from our ambassadors about their experience.
        </p>
      </div>
